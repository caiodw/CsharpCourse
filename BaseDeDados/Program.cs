...
namespace BaseDeDados
{
    internal class Program
    {
        static void Main(string[] args)
        {
            try
            {
                BeerDB beerDB = new BeerDB(@"SPIN5\SQLEXPRESS", "CsharpDB", "sa", "n0v4v1d4");
                bool again = true;
                int op = 0;
                ...
                {
                    ShowMenu();
                    Console.WriteLine("Elige una opcíon: ");
        ...
        {
            Console.Clear();
            Console.WriteLine("Agregar bueva cerveza");
            Console.WriteLine("Escrebe el nombre:");
